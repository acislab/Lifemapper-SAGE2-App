...
var _user$project$StatsHeatMap$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ReceivedStats') {
			var selectedVariable = 'alpha';
			var variables = A2(
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					...
					{
						variables: variables,
						statNames: _elm_lang$core$Dict$fromList(_p0._0.statNameLookup),
						statRanges: _elm_lang$core$Dict$fromList(_p0._0.statRanges),
...
var _user$project$StatsHeatMap$requestStats = _elm_lang$core$Native_Platform.outgoingPort(
	'requestStats',
	function (v) {
		return null;
	});
var _user$project$StatsHeatMap$statsForSites = _elm_lang$core$Native_Platform.incomingPort(
	'statsForSites',
	A2(
		_elm_lang$core$Json_Decode$andThen,
					...
					return A2(
						...
						function (statRanges) {
							return _elm_lang$core$Json_Decode$succeed(
								{sitesObserved: sitesObserved, statNameLookup: statNameLookup, statRanges: statRanges});
						},
						A2(
...
var _user$project$StatsHeatMap$StatsForSite = F2(
	function (a, b) {
		return {id: a, stats: b};
	});
var _user$project$StatsHeatMap$Model = F4(
	function (a, b, c, d) {
		return {variables: a, statNames: b, statRanges: c, selectedVariable: d};
	});
var _user$project$StatsHeatMap$Record = F3(
	function (a, b, c) {
		return {siteId: a, x: b, y: c};
	});
var _user$project$StatsHeatMap$extractRecord = F3(
	function (xCol, yCol, stats) {
		...
		return _elm_lang$core$Result$toMaybe(
			A3(
				...
				_user$project$StatsHeatMap$Record(stats.id),
				getValue(xCol),
				getValue(yCol)));
	});
var _user$project$StatsHeatMap$recordsFromStats = F3(
	function (xCol, yCol, stats) {
		return _elm_community$maybe_extra$Maybe_Extra$values(
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$StatsHeatMap$extractRecord, xCol, yCol),
				stats));
	});
var _user$project$StatsHeatMap$ReceivedStats = function (a) {
	return {ctor: 'ReceivedStats', _0: a};
};
var _user$project$StatsHeatMap$VariableSelectedMsg = function (a) {
	return {ctor: 'VariableSelectedMsg', _0: a};
};
var _user$project$StatsHeatMap$view = function (model) {
	var text = A2(
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						...
						A2(_elm_lang$core$Dict$get, model.selectedVariable, model.statNames)))),
			_1: {ctor: '[]'}
		});
	var legend = A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background', _1: 'linear-gradient(white, red)'},
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'margin', _1: '50px 10px'},
										_1: {
											ctor: '::',
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Maybe$map,
								function (_p4) {
									return _user$project$Helpers$formatNumber(
										function (_) {
											return _.min;
										}(_p4));
								},
								A2(_elm_lang$core$Dict$get, model.selectedVariable, model.statRanges)))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-map-selected-var', model.selectedVariable),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(variableSelector, model.selectedVariable, _user$project$StatsHeatMap$VariableSelectedMsg),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(' statistic displayed on map'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$StatsHeatMap$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: {
				...
				statRanges: _elm_lang$core$Dict$empty,
				selectedVariable: ''
			},
			_1: _user$project$StatsHeatMap$requestStats(
				{ctor: '_Tuple0'})
		},
		update: _user$project$StatsHeatMap$update,
		view: _user$project$StatsHeatMap$view,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$StatsHeatMap$statsForSites(_user$project$StatsHeatMap$ReceivedStats))
	})();

var Elm = {};
Elm['StatsHeatMap'] = Elm['StatsHeatMap'] || {};
if (typeof _user$project$StatsHeatMap$main !== 'undefined') {
    _user$project$StatsHeatMap$main(Elm['StatsHeatMap'], 'StatsHeatMap', undefined);
}
