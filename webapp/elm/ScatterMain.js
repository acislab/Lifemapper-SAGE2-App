...
var _user$project$DecodeTree$removeUnderscore = _elm_lang$core$Json_Decode$map(
	function (_p0) {
		return A2(
			...
			A2(_elm_lang$core$Maybe$withDefault, '', _p0));
	});
var _user$project$DecodeTree$TreeData = F4(
	function (a, b, c, d) {
		return {cladeId: a, length: b, name: c, squid: d};
	});
var _user$project$DecodeTree$TreeRecord = F2(
	function (a, b) {
		return {data: a, children: b};
	});
var _user$project$DecodeTree$Leaf = function (a) {
	return {ctor: 'Leaf', _0: a};
};
var _user$project$DecodeTree$Node = F3(
	function (a, b, c) {
		return {ctor: 'Node', _0: a, _1: b, _2: c};
	});
var _user$project$DecodeTree$checkBinary = function (_p1) {
	var _p2 = _p1;
	var _p4 = _p2.data;
	var _p3 = _p2.children;
	if (_p3.ctor === '[]') {
		return _elm_lang$core$Json_Decode$succeed(
			_user$project$DecodeTree$Leaf(_p4));
	} else {
		if (_p3._1.ctor === '[]') {
			return _elm_lang$core$Json_Decode$fail('found node with single child.');
		} else {
			if (_p3._1._1.ctor === '[]') {
				return _elm_lang$core$Json_Decode$succeed(
					A3(_user$project$DecodeTree$Node, _p4, _p3._0, _p3._1._0));
			} else {
				return _elm_lang$core$Json_Decode$fail('found node with more than two children.');
			}
		}
	}
};
var _user$project$DecodeTree$treeDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	_user$project$DecodeTree$checkBinary,
	A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$DecodeTree$TreeRecord,
		A5(
			_elm_lang$core$Json_Decode$map4,
			_user$project$DecodeTree$TreeData,
			A2(_elm_lang$core$Json_Decode$field, 'cladeId', _elm_lang$core$Json_Decode$int),
			_elm_lang$core$Json_Decode$maybe(
				A2(_elm_lang$core$Json_Decode$field, 'length', _elm_lang$core$Json_Decode$float)),
			_user$project$DecodeTree$removeUnderscore(
				_elm_lang$core$Json_Decode$maybe(
					A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string))),
			_elm_lang$core$Json_Decode$maybe(
				A2(_elm_lang$core$Json_Decode$field, 'squid', _elm_lang$core$Json_Decode$string))),
		A2(
...
var _user$project$Newick$Branch = function (a) {
	return {ctor: 'Branch', _0: a};
};
var _user$project$Newick$SubTree = function (a) {
	return {ctor: 'SubTree', _0: a};
};
var _user$project$Newick$Branches = F2(
	function (a, b) {
		return {ctor: 'Branches', _0: a, _1: b};
	});
var _user$project$Newick$Leaf = function (a) {
	return {ctor: 'Leaf', _0: a};
};
...
var _user$project$Newick$subTree = function (_p7) {
	...
	return _elm_community$parser_combinators$Combine$choice(
		{
			ctor: '::',
			_0: _elm_community$parser_combinators$Combine$lazy(_user$project$Newick$internal),
			_1: {
				ctor: '::',
				_0: _user$project$Newick$leaf,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Newick$internal = function (_p9) {
	...
	return A2(
		...
		function (branches) {
			return A2(
				_elm_community$parser_combinators$Combine$map,
				_user$project$Newick$Branches(branches),
				_user$project$Newick$name);
		},
	...
	return A2(
		...
		function (st) {
			return A2(
				...
				_user$project$Newick$length);
		},
		_elm_community$parser_combinators$Combine$lazy(_user$project$Newick$subTree));
};
var _user$project$Newick$tree = A2(
	_elm_community$parser_combinators$Combine_ops['<*'],
	_elm_community$parser_combinators$Combine$choice(
		{
			ctor: '::',
...
var _user$project$TaxLabels$squid = A2(
	_elm_community$parser_combinators$Combine_ops['<*'],
	A2(
		_elm_community$parser_combinators$Combine_ops['*>'],
...
var _user$project$TaxLabels$taxLabel = A2(
	_elm_community$parser_combinators$Combine$andThen,
	function (name) {
		return A2(
			_elm_community$parser_combinators$Combine$map,
			function (squid) {
				return {name: name, squid: squid};
			},
			_elm_community$parser_combinators$Combine$maybe(
				A2(_elm_community$parser_combinators$Combine_ops['*>'], _elm_community$parser_combinators$Combine$whitespace, _user$project$TaxLabels$squid)));
	},
	_user$project$TaxLabels$name);
var _user$project$TaxLabels$taxLabels = A2(
	_elm_community$parser_combinators$Combine_ops['<*'],
	A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		A2(
			...
			A2(
				_elm_community$parser_combinators$Combine_ops['*>'],
				_elm_community$parser_combinators$Combine$string('TAXLABELS'),
				_elm_community$parser_combinators$Combine$whitespace1),
			A2(_elm_community$parser_combinators$Combine$sepBy, _elm_community$parser_combinators$Combine$whitespace1, _user$project$TaxLabels$taxLabel)),
		_elm_community$parser_combinators$Combine$whitespace),
	_elm_community$parser_combinators$Combine$string(';'));
var _user$project$TaxLabels$TaxLabel = F2(
	function (a, b) {
		return {name: a, squid: b};
	});

var _user$project$Newick2Binary$cladeIdOnlyRegex = _elm_lang$core$Regex$regex('^(\\d+)$');
var _user$project$Newick2Binary$nodeIdRegex = _elm_lang$core$Regex$regex('Node_(\\d+)');
var _user$project$Newick2Binary$name2Id = function (name) {
	return A2(
		...
		_elm_community$maybe_extra$Maybe_Extra$join(
			A2(
				_elm_lang$core$Maybe$andThen,
				_elm_community$list_extra$List_Extra$getAt(0),
				A2(
					_elm_lang$core$Maybe$map,
					function (_) {
						return _.submatches;
					...
					A2(
						...
						A2(
							...
							A3(
								_elm_lang$core$Regex$find,
								_elm_lang$core$Regex$AtMost(1),
								_user$project$Newick2Binary$nodeIdRegex,
								name)),
						A2(
							_elm_community$list_extra$List_Extra$getAt,
							0,
							A3(
								_elm_lang$core$Regex$find,
								_elm_lang$core$Regex$AtMost(1),
								_user$project$Newick2Binary$cladeIdOnlyRegex,
								name)))))));
};
var _user$project$Newick2Binary$subTree2Binary = F3(
	function (names2squids, length, st) {
		var _p1 = st;
		if (_p1.ctor === 'Leaf') {
			var _p2 = _p1._0;
			return _user$project$DecodeTree$Leaf(
				{
					cladeId: A2(
						_elm_lang$core$Maybe$withDefault,
						-1,
						_user$project$Newick2Binary$name2Id(_p2)),
					length: length,
					name: _p2,
					squid: _elm_community$maybe_extra$Maybe_Extra$join(
						A2(_elm_lang$core$Dict$get, _p2, names2squids))
				});
		} else {
			if (((((_p1._0.ctor === '::') && (_p1._0._0.ctor === '_Tuple2')) && (_p1._0._1.ctor === '::')) && (_p1._0._1._0.ctor === '_Tuple2')) && (_p1._0._1._1.ctor === '[]')) {
				var _p3 = _p1._1;
				return A3(
					_user$project$DecodeTree$Node,
					{
						cladeId: A2(
							_elm_lang$core$Maybe$withDefault,
							-1,
							_user$project$Newick2Binary$name2Id(_p3)),
						length: length,
						name: _p3,
						squid: _elm_community$maybe_extra$Maybe_Extra$join(
							A2(_elm_lang$core$Dict$get, _p3, names2squids))
					},
					A3(_user$project$Newick2Binary$subTree2Binary, names2squids, _p1._0._0._1, _p1._0._0._0),
					A3(_user$project$Newick2Binary$subTree2Binary, names2squids, _p1._0._1._0._1, _p1._0._1._0._0));
			} else {
				return A2(
					...
					'Found non binary subtree structure',
					st);
			}
		}
	});
var _user$project$Newick2Binary$newick2Binary = F2(
	function (taxlabels, tree) {
		var names2squids = _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (_p4) {
					var _p5 = _p4;
					return {ctor: '_Tuple2', _0: _p5.name, _1: _p5.squid};
				},
				taxlabels));
		var _p6 = tree;
		if (_p6.ctor === 'SubTree') {
			return A3(
				_user$project$Newick2Binary$subTree2Binary,
				names2squids,
				_elm_lang$core$Maybe$Just(0),
				_p6._0);
		} else {
			return A3(_user$project$Newick2Binary$subTree2Binary, names2squids, _p6._0._1, _p6._0._0);
		}
	});
...
var _user$project$ParseNexusTree$taxLabelsRegex = _elm_lang$core$Regex$regex('TAXLABELS[^;]*;');
					...
					A2(
						...
						A2(
							...
							A3(
								_elm_lang$core$Regex$find,
								_elm_lang$core$Regex$AtMost(1),
								_user$project$ParseNexusTree$treeRegex,
								nexus)))))));
	var taxa = A2(
		_elm_lang$core$Result$andThen,
			...
			A2(
				...
				A2(
					...
					A3(
						_elm_lang$core$Regex$find,
						_elm_lang$core$Regex$AtMost(1),
						_user$project$ParseNexusTree$taxLabelsRegex,
						nexus)))));
	return A3(_elm_lang$core$Result$map2, _user$project$Newick2Binary$newick2Binary, taxa, tree);
};

var _user$project$TreeMetrics$treeBreadth = function (tree) {
	var _p0 = tree;
	if (_p0.ctor === 'Leaf') {
		return 1;
	} else {
		return _user$project$TreeMetrics$treeBreadth(_p0._1) + _user$project$TreeMetrics$treeBreadth(_p0._2);
	}
};
var _user$project$TreeMetrics$treeDepth = function (tree) {
	var _p1 = tree;
	if (_p1.ctor === 'Leaf') {
		return 1;
	} else {
		return 1 + A2(
			...
			_user$project$TreeMetrics$treeDepth(_p1._1),
			_user$project$TreeMetrics$treeDepth(_p1._2));
	}
};
var _user$project$TreeMetrics$treeLength = function (tree) {
	var _p2 = tree;
	if (_p2.ctor === 'Leaf') {
		return A2(_elm_lang$core$Maybe$withDefault, 0, _p2._0.length);
	} else {
		var thisLength = A2(_elm_lang$core$Maybe$withDefault, 0, _p2._0.length);
		return thisLength + A2(
			_elm_lang$core$Basics$max,
			_user$project$TreeMetrics$treeLength(_p2._1),
			_user$project$TreeMetrics$treeLength(_p2._2));
	}
};
...
var _user$project$McpaModel$init = F2(
	function (parseData, flags) {
		var root = function () {
			var _p1 = _user$project$ParseNexusTree$parseNexusTree(flags.taxonTree);
			if (_p1.ctor === 'Ok') {
				return _p1._0;
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
		...
		var treeInfo = {
			root: root,
			length: _user$project$TreeMetrics$treeLength(root),
			depth: _user$project$TreeMetrics$treeDepth(root),
			breadth: _user$project$TreeMetrics$treeBreadth(root)
		};
		var _p3 = parseData(flags.data);
		var variables = _p3._0;
		var data = _p3._1;
		return {
			ctor: '_Tuple2',
			_0: {
...
var _user$project$McpaModel$Flags = F2(
	function (a, b) {
		return {data: a, taxonTree: b};
	});
var _user$project$McpaModel$TreeInfo = F4(
	function (a, b, c, d) {
...
var _user$project$McpaTreeView$viewTree = F3(
	function (model, redBlue, selectData) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: A2(_user$project$LinearTreeView$computeColor, 1.0, 0.0),
			_1: A2(_user$project$LinearTreeView$computeColor, 1.0, 1.0)
		};
		var color0 = _p0._0;
		var color1 = _p0._1;
		var legend = A2(
								...
								_1: A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											', ',
											A2(_elm_lang$core$Basics_ops['++'], color1, ')'))))
							},
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'margin', _1: '0px 0'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'outline', _1: 'solid 2px'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'outline-offset', _1: '-2px'},
													_1: {ctor: '[]'}
												}
											}
										}
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$p,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'margin', _1: '3px 6px'},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Semipartial Correlation b/w Node and Selected Predictor'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('1.0'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$StatsMain$svgViewBox = {width: 500, height: 500, minX: -100, minY: 0, maxX: 1020, maxY: 1020};
...
var _user$project$StatsMain$init = {
	...
	_0: {
		...
		flagged: _elm_lang$core$Dict$empty,
		variables: {ctor: '[]'},
...
var _user$project$StatsMain$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {selected: a, flagged: b, selecting: c, variables: d, statNames: e, stats: f, displayedRecords: g, scale: h, xCol: i, yCol: j, xSelectorClosed: k, ySelectorClosed: l};
											};
										};
									};
								};
...
var _user$project$StatsMain$update = F2(
	function (msg, model) {
		var _p24 = msg;
		switch (_p24.ctor) {
			case 'ToggleXSelector':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{xSelectorClosed: !model.xSelectorClosed}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CloseXSelector':
				return {
			...
			case 'ToggleYSelector':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{ySelectorClosed: !model.ySelectorClosed}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CloseYSelector':
				return {
			...
			case 'ReceivedStats':
				var _p29 = _p24._0.sitesObserved;
				var yCol = 'phi';
				var xCol = 'alpha';
				var records = A3(
					_user$project$StatsMain$recordsFromStats,
					xCol,
					yCol,
					A2(
						_elm_lang$core$List$filter,
			...
			case 'XColSelectedMsg':
				var _p30 = _p24._0;
				var records = A3(_user$project$StatsMain$recordsFromStats, _p30, model.yCol, model.stats);
				var scale = _user$project$StatsMain$computeScale(records);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{xCol: _p30, displayedRecords: records, scale: scale}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'YColSelectedMsg':
				var _p31 = _p24._0;
				var records = A3(_user$project$StatsMain$recordsFromStats, model.xCol, _p31, model.stats);
				var scale = _user$project$StatsMain$computeScale(records);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{yCol: _p31, displayedRecords: records, scale: scale}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
				...
				switch (_p32) {
					case 'mousedown':
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{selecting: selecting, flagged: _elm_lang$core$Dict$empty}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'mousemove':
						var _p33 = model.selecting;
						if (_p33.ctor === 'Just') {
							var p2 = A2(
								_user$project$StatsMain$pixel2svg,
								_user$project$StatsMain$svgViewBox,
							...
							var selecting = _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple2', _0: _p33._0._0, _1: p2});
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
					...
					case 'mouseup':
						...
						if (_p34.ctor === 'Just') {
							...
							var _p35 = {
								ctor: '_Tuple2',
								_0: A2(_user$project$StatsMain$svg2data, model.scale, _p34._0._0),
							...
							var selected = _p38.ctrlKey ? A2(_elm_lang$core$Set$union, model.selected, newlySelected) : newlySelected;
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									if (A2(_elm_lang$core$Set$member, record.siteId, model.selected)) {
										return _elm_lang$svg$Svg_Attributes$fill('red');
									} else {
										var _p40 = A2(_elm_lang$core$Dict$get, record.siteId, model.flagged);
										if (_p40.ctor === 'Just') {
											return _elm_lang$svg$Svg_Attributes$fill(_p40._0);
										} else {
											return _elm_lang$svg$Svg_Attributes$fill('black');
										}
									}
								}(),
								_1: {ctor: '[]'}
...
var _user$project$StatsMain$CloseYSelector = {ctor: 'CloseYSelector'};
var _user$project$StatsMain$CloseXSelector = {ctor: 'CloseXSelector'};
var _user$project$StatsMain$ToggleYSelector = {ctor: 'ToggleYSelector'};
var _user$project$StatsMain$ToggleXSelector = {ctor: 'ToggleXSelector'};
...
var _user$project$StatsMain$viewPlot = function (model) {
	...
	var liHeight = 19;
	var selectorHeight = function () {
		var _p41 = model.xSelectorClosed;
		if (_p41 === true) {
			return liHeight;
		} else {
			return ((liHeight + liBorder) * _elm_lang$core$List$length(model.variables)) - liBorder;
		}
	}();
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'closed',
											_1: _elm_lang$core$Native_Utils.eq(model.xSelectorClosed, true)
										},
										_1: {ctor: '[]'}
									}
								}),
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$StatsMain$ToggleXSelector),
															_1: {ctor: '[]'}
														}
													}
												},
	...
	var selectionBox = A2(
		...
		function (_p42) {
			...
			var _p44 = {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$abs(_p47.x - _p46.x),
				_1: _elm_lang$core$Basics$abs(_p47.y - _p46.y)
			};
			var w = _p44._0;
			var h = _p44._1;
			var _p45 = {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$Basics$min, _p46.x, _p47.x),
				_1: A2(_elm_lang$core$Basics$min, _p46.y, _p47.y)
			};
			var x_ = _p45._0;
			var y_ = _p45._1;
			return A2(
...
var _user$project$ScatterView$parseData = function (data) {
...
var _user$project$ScatterView$requestSitesForNode = _elm_lang$core$Native_Platform.outgoingPort(
	'requestSitesForNode',
	function (v) {
		return v;
	});
var _user$project$ScatterView$sitesForNode = _elm_lang$core$Native_Platform.incomingPort(
	'sitesForNode',
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _user$project$ScatterView$requestNodesForSites = _elm_lang$core$Native_Platform.outgoingPort(
...
var _user$project$ScatterView$nodesForSites = _elm_lang$core$Native_Platform.incomingPort(
	'nodesForSites',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
		...
		A2(
			...
			0,
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int))));
var _user$project$ScatterView$Model = F2(
	function (a, b) {
		return {mcpaModel: a, statsModel: b};
	});
var _user$project$ScatterView$SetSelectedNodes = function (a) {
	return {ctor: 'SetSelectedNodes', _0: a};
};
var _user$project$ScatterView$SetSelectedSites = function (a) {
	return {ctor: 'SetSelectedSites', _0: a};
};
var _user$project$ScatterView$StatsMsg = function (a) {
	return {ctor: 'StatsMsg', _0: a};
};
var _user$project$ScatterView$view = function (_p2) {
	var _p3 = _p2;
	var _p5 = _p3.statsModel;
	var _p4 = _p3.mcpaModel;
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'width', _1: '12px'},
						_1: {
							ctor: '::',
	...
	var selectData = function (cladeId) {
		return A2(
			...
			{ctor: '_Tuple3', _0: cladeId, _1: 'Observed', _2: _p4.selectedVariable},
			_p4.data);
	};
	var selectedSiteIds = A2(
		_elm_lang$core$String$join,
		...
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Basics$toString,
			_elm_lang$core$Set$toList(_p5.selected)));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						_user$project$ScatterView$StatsMsg,
						_user$project$StatsMain$viewPlot(_p5)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$ScatterView$McpaMsg = function (a) {
	return {ctor: 'McpaMsg', _0: a};
};
var _user$project$ScatterView$update = F2(
	function (msg, _p6) {
		var _p7 = _p6;
		var _p16 = _p7;
		var _p8 = msg;
		switch (_p8.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p16,
						{
							mcpaModel: _elm_lang$core$Native_Utils.update(
								...
								{
									selectedNode: _elm_lang$core$Maybe$Nothing,
									flaggedNodes: {ctor: '_Tuple2', _0: _p8._0._0, _1: _p8._0._1}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					A2(
						...
						function (_p9) {
							...
							switch (_p11) {
								case 'left':
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: _p12, _1: 'blue'});
								case 'right':
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: _p12, _1: 'red'});
								case 'both':
									return _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: _p12, _1: 'purple'});
								default:
									return _elm_lang$core$Maybe$Nothing;
							}
						},
			...
			case 'McpaMsg':
				if (_p8._0.ctor === 'SelectNode') {
					var _p13 = A2(_user$project$McpaModel$update, _p8._0, _p16.mcpaModel);
					...
					return A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$ScatterView$McpaMsg, cmd),
							_1: {
								ctor: '::',
								_0: _user$project$ScatterView$requestSitesForNode(_p8._0._0),
								_1: {ctor: '[]'}
							}
						});
				} else {
					var _p14 = A2(_user$project$McpaModel$update, _p8._0, _p16.mcpaModel);
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							_p16,
							{mcpaModel: mcpaModel}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$ScatterView$McpaMsg, cmd)
					};
				}
			default:
				var _p15 = A2(_user$project$StatsMain$update, _p8._0, _p16.statsModel);
				var statsModel = _p15._0;
				var cmd = _p15._1;
				var getNodes = (!_elm_lang$core$Native_Utils.eq(statsModel.selected, _p16.statsModel.selected)) ? _user$project$ScatterView$requestNodesForSites(
				...
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$ScatterView$StatsMsg, cmd),
						_1: {
							ctor: '::',
							_0: getNodes,
							_1: {ctor: '[]'}
...
var _user$project$ScatterView$init = function (flags) {
	var _p17 = _user$project$StatsMain$init;
	var statsModel = _p17._0;
	var statsCmd = _p17._1;
	var _p18 = A2(_user$project$McpaModel$init, _user$project$ScatterView$parseData, flags);
	var mcpaModel = _p18._0;
	var mcpaCmd = _p18._1;
	return {
		ctor: '_Tuple2',
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$ScatterView$McpaMsg, mcpaCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$ScatterView$StatsMsg, statsCmd),
					_1: {ctor: '[]'}
				}
			})
	};
};
var _user$project$ScatterView$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$ScatterView$McpaMsg,
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$ScatterView$sitesForNode(_user$project$ScatterView$SetSelectedSites),
					_1: {
						ctor: '::',
						_0: _user$project$ScatterView$nodesForSites(_user$project$ScatterView$SetSelectedNodes),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$ScatterView$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$ScatterView$init, update: _user$project$ScatterView$update, view: _user$project$ScatterView$view, subscriptions: _user$project$ScatterView$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (data) {
			return A2(
...
var Elm = {};
Elm['ScatterView'] = Elm['ScatterView'] || {};
if (typeof _user$project$ScatterView$main !== 'undefined') {
    _user$project$ScatterView$main(Elm['ScatterView'], 'ScatterView', undefined);
}
