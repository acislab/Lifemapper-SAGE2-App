...
var _user$project$MapView$update = F2(
	function (msg, _p7) {
		...
		switch (_p9.ctor) {
			...
			case 'McpaMsg':
				var _p14 = A2(_user$project$McpaModel$update, _p9._0, _p16.mcpaModel);
			...
			default:
				var _p15 = A2(_user$project$StatsMain$update, _p9._0, _p16.statsModel);
				var statsModel = _p15._0;
				var cmd = _p15._1;
				var getNodes = (!_elm_lang$core$Native_Utils.eq(statsModel.selected, _p16.statsModel.selected)) ? _user$project$MapView$requestNodesForSites(
...
var _user$project$MapView$init = function (flags) {
	...
	var _p18 = A2(_user$project$McpaModel$init, _user$project$MapView$parseData, flags);
