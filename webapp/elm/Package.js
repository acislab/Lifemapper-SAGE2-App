...
var _user$project$StatsTreeMap$update = F2(
	function (msg, _p2) {
		...
		switch (_p4.ctor) {
			...
			case 'McpaMsg':
				var _p9 = A2(_user$project$McpaModel$update, _p4._0, _p11.mcpaModel);
			...
			default:
				var _p10 = A2(_user$project$StatsMain$update, _p4._0, _p11.statsModel);
				var statsModel = _p10._0;
				var cmd = _p10._1;
				var getNodes = (!_elm_lang$core$Native_Utils.eq(statsModel.selected, _p11.statsModel.selected)) ? _user$project$StatsTreeMap$requestNodesForSites(
...
var _user$project$StatsTreeMap$view = function (_p12) {
	var _p13 = _p12;
	var _p16 = _p13.statsModel;
	var _p15 = _p13.mcpaModel;
	...
	var legend = function () {
		...
		if (_p14.ctor === 'Just') {
			...
			return (!_elm_lang$core$Set$isEmpty(_p16.selected)) ? A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Set$size(_p16.selected)),
										' selected sites = '))),
							_1: {
								ctor: '::',
								_0: block('red'),
	...
	var selectedSiteIds = A2(
		...
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Basics$toString,
			_elm_lang$core$Set$toList(_p16.selected)));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_1: {
													...
													_1: {
														...
														_0: A2(
															...
															A2(
																_elm_lang$core$Maybe$withDefault,
																'',
																A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, _p15.selectedNode))),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$style(
																{
						...
						_1: {
							...
							_0: A2(
								...
								_user$project$StatsMain$viewPlot(_p16)),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$StatsTreeMap$init = function (flags) {
	...
	var _p18 = A2(_user$project$McpaModel$init, _user$project$StatsTreeMap$parseData, flags);
...
var _user$project$Package$openMap = _elm_lang$core$Native_Platform.outgoingPort(
	'openMap',
	function (v) {
		return null;
	});
var _user$project$Package$openScatter = _elm_lang$core$Native_Platform.outgoingPort(
	'openScatter',
	function (v) {
		return null;
	});
		...
		switch (_p0.ctor) {
			...
			case 'OpenMap':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Package$openMap(
						{ctor: '_Tuple0'})
				};
			case 'OpenScatter':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Package$openScatter(
						{ctor: '_Tuple0'})
				};
			case 'OpenProjection':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Package$openProjection = _elm_lang$core$Native_Platform.outgoingPort(
	'openProjection',
	function (v) {
		return null;
	});
